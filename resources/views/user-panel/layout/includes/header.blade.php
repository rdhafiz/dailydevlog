        ...
        <div
            ...
            <div class="flex items-center">
                <div class="relative inline-block text-left" id="search-dropdown-menu">
                    ...
                    <div
                        class="hidden absolute -right-[130px] sm:right-0 z-10 mt-4 w-[320px] sm:w-[340px] p-0 bg-white rounded-[100px] overflow-hidden"
                        id="search-dropdown">
                        <div role="none" class="p-1">
                            <form @submit.prevent="searchData">
                                <div class="relative">
                                    <input type="text" placeholder="Type to search article..."
                                           class="py-3 px-5 outline-0 w-full border text-black h-[50px] rounded-[100px] font-[400] text-[13px] placeholder-[#C0C0C0]"
                            ...
                            <div role="none">
                                <div class="flex justify-start items-center pt-[8px] pb-[8px] ps-[12px]">
                                    ...
                                    <span class="ms-[8px]">
                                        ...
                                        <span
                                            class="block font-[400] text-[10px] text-[#55608080] dark:text-[#ECEBF780]"> ridwanul.hafiz@gmail.com </span>
                                    </span>
                                </div>
