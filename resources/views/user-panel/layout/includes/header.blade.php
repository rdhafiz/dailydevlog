...
<header
    ...
    id="header">
    <div class="bg-white dark:bg-[#222222] text-secondary dark:text-white shadow p-2 rounded-[100px] flex items-center justify-between mx-auto container">
        <a href="{{route('user.panel.home')}}" class="hidden md:block">
            <img src="{{asset('/images/logo.svg')}}" alt="logo">
        </a>
        <ul class="items-center center hidden md:flex">
            <li>
                <a href="{{route('user.panel.feature.post')}}" class="dark:text-white hover:text-second dark:hover:text-second duration-500 text-[13px] block">Featured</a>
            </li>
            <li>
            ...
            <li>
                <a href="{{route('user.panel.most.viewed.post')}}" class="dark:text-white hover:text-second dark:hover:text-second duration-500 text-[13px] block">Most
                    Viewed</a>
            </li>
        </ul>
        <a href="javascript:void(0)" class="inline-block md:hidden sm:px-2" @click="toggleMenu">
        ...
        <div class="flex items-center">
            ...
            <a href="javascript:void(0)" class="mx-2 hidden dark:block" onclick="lightMode()">
                <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg"
                     xmlns:xlink="http://www.w3.org/1999/xlink">
                    <rect x="30" y="30" width="30" height="30" rx="15" transform="rotate(180 30 30)" fill="#556080"/>
                    <path
            ...
            <a href="javascript:void(0)" class="mx-2 block dark:hidden" onclick="darkMode()">
                <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg"
                     xmlns:xlink="http://www.w3.org/1999/xlink">
                    <rect x="30" y="30" width="30" height="30" rx="15" transform="rotate(180 30 30)" fill="#556080"/>
                    <path
            ...
            @else
                <a href="{{route('user.panel.login')}}" class="bg-second text-white rounded-2xl py-2 hover:bg-[#8bad1a] duration-500 px-5">
                    Login
                </a>
            @endif
        </div>
