                ...
                <form id="managePost" enctype='multipart/form-data' action="/api/front/posts">
                    <div class="w-full flex-wrap flex">
                        ...
                        <div class="mb-5 w-full px-4">
                            ...
                            @error('title')
                                <div class="error-report text-red-500 text-sm mt-2"> {{$message}} </div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-5 w-full px-4">
                            ...
                            <textarea name="content" id="content_description" value="{{old('content_description')}}" placeholder="Write your content here"
