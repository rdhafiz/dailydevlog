            ...
            <div class="px-3" v-if="tableData.length > 0 && !loading">
                <div class="w-full mt-10 border border-cyan-400 max-[1520px]:overflow-x-scroll">
                    <table class="w-[1510px]">
                        ...
                        <tr>
                            <th class="w-[250px] p-3 text-start"> Title</th>
                            <th class="w-[250px] p-3 text-start"> Status</th>
                            <th class="w-[250px] p-3 text-start"> Views count</th>
                            <th class="w-[250px] p-3 text-start"> featured</th>
                            <th class="w-[250px] p-3 text-start"> comments access</th>
                            <th class="w-[250px] p-3 text-center"> Action</th>
                        </tr>
                        </thead>
                        ...
                        <tr class="text-center" v-for="(each) in tableData">
                            ...
                            <td class="w-[250px] p-3 text-start"> @{{each.status}}</td>
                            <td class="w-[250px] p-3 text-start"> @{{each.views_count}}</td>
                            <td class="w-[250px] p-3 text-start"> @{{each.is_featured}}</td>
                            <td class="w-[250px] p-3 text-start"> @{{each.allow_comments}}</td>
                            <td class="w-[250px] p-3">
                                <div class="flex justify-center gap-x-5 items-center">
                                    <a :href="'/post/'+each.id" class="bg-transparent decoration-0">
                                        <svg viewBox="0 0 24 24" class="w-[21px] h-[21px]" fill="none"
                                            ...
                                            <g id="SVGRepo_iconCarrier">
                                                <path
                                                    ...
                                                    class="stroke-cyan-700 dark:stroke-white" stroke-width="2"
                                                    stroke-linecap="round" stroke-linejoin="round"></path>
                                            </g>
                                        </svg>
                                    </a>
                                    <a :href="'/blog-details/'+each.id" class="bg-transparent decoration-0">
                                        <svg viewBox="0 0 24 24" class="w-[21px] h-[21px]" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round"
                                               stroke-linejoin="round"></g>
                                            <g id="SVGRepo_iconCarrier">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                      ...
                                                      class="stroke-cyan-700 dark:stroke-white"></path>
                                            </g>
                                        </svg>
                                    </a>
                                    <button type="button" class="bg-transparent decoration-0"
                                        ...
                                        <svg viewBox="0 0 24 24" class="w-[21px] h-[21px]" fill="none"
                                            ...
                                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round"
                                               stroke-linejoin="round"></g>
                                            <g id="SVGRepo_iconCarrier">
                                                <path d="M4 7H20" class="stroke-cyan-700 dark:stroke-white"
                ...
                <div class="mt-5 flex justify-center items-center" v-if="tableData.length > 0 && loading === false">
                    <div class="flex justify-center items-center">
                        <div @click="PrevPage()">
                            <a class="p-3 border border-cyan-400 outline-0 w-[45px] h-[45px] flex justify-center items-center"
                               href="#">
                        ...
                        <div v-if="buttons.length <= 6">
                            <div v-for="(page, index) in buttons">
                                <a class="p-3 border border-cyan-400 outline-0 w-[45px] h-[45px] flex justify-center items-center"
                                   @click="pageChange(page)" href="javascript:void(0)"
                                   v-text="page"></a>
                            </div>
                        </div>
                        <div v-if="buttons.length > 6">
                            ...
                            <div v-if="current_page > 3">
                                <a class="p-3 border border-cyan-400 outline-0 w-[45px] h-[45px] flex justify-center items-center"
                                   @click="pageChange(current_page - 2)"
                            ...
                            ">
                            <a class="p-3 border border-cyan-400 outline-0 w-[45px] h-[45px] flex justify-center items-center"
                               @click="pageChange(current_page)" href="javascript:void(0)"
                        ...
                        <div :class="{'active': current_page == (current_page - buttons.length)}">
                            <a class="p-3 border border-cyan-400 outline-0 w-[45px] h-[45px] flex justify-center items-center"
                               @click="pageChange(buttons.length)"
