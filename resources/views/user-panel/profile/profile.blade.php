                            ...
                            <form action="{{ route('API.USER.UPDATE.AVATAR') }}" id="update-avatar" method="post"
                                ...
                                <div id="changeAvatar">
                                    <label for="upload-profile-avatar">
                                        <div
                                            class="rounded-full w-[200px] lg:w-[250px] h-[200px] bg-cover object-cover lg:h-[250px] overflow-hidden group">
                                            <img src="{{ asset('storage/media/'.$user['avatar']) }}"
                ...
                <div class="w-full lg:w-2/3 px-3">
                    <div
                        ...
                        <form id="profile-update" method="post" action="{{ route('API.USER.UPDATE.PROFILE') }}">
                            ...
                            <section class="w-full mb-7">
                                <div class="decoration-0 text-gray-600 font-semibold dark:text-cyan-400">Edit Profile
                                </div>
                            ...
                            <div class="mb-5">
                                ...
                                <textarea name="bio" id="user-bio"
                                          ...
                                          placeholder="Enter your bio" autocomplete="off"> {{$user['bio']}} </textarea>
                                @error('bio')
                                <div class="text-[12px] font-[600] text-red mt-2">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-5">
                                ...
                                <input id="user-website" type="text" name="website" value="{{$user['website']}}"
                                       class="py-5 pe-5 border-0 border-b border-b-cyan-400 bg-transparent text-black w-full outline-0 dark:text-white"
                            ...
                            <div class="flex justify-start items-center">
                                ...
                                <span id="profileUpdateLoading" class="hidden">
                                    <button type="button"
                                            class="btn-theme rounded-md w-[120px] justify-center items-center h-[45px] text-white"
                                            disabled>
                                        <svg class="h-5 mx-auto w-5 animate-spin text-white"
                                             xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor"
                    ...
                    <div
                        ...
                        <form id="change-password" method="post" action="{{ route('API.USER.CHANGE.PASSWORD') }}">
                            @csrf
                            <section class="w-full mb-7">
                                <div class="decoration-0 text-gray-600 font-semibold dark:text-cyan-400">Change
                                    Password
                                </div>
                                <hr class="w-full border border-cyan-300 my-5 px-5 md:px-[120px]">
                            </section>
                            <div class="mb-5">
                                <label for="user_current_password" class="block font-semibold"> Current
                                    password </label>
                                <input id="user_current_password" type="password" name="current_password"
                            ...
                            <div class="flex justify-start items-center">
                                ...
                                <span id="changePasswordLoader" class="hidden">
                                    <button type="button"
                                            class="btn-theme rounded-md flex w-[120px] justify-center items-center h-[45px] text-white"
                                            disabled>
                                    <svg class="h-5 mx-auto w-5 animate-spin text-white"
                                         xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                        <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor"
